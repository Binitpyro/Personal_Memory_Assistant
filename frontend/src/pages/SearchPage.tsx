...
/**
 * Chat UI page that submits user questions to a streaming backend, displays incremental assistant responses (including retrieval sources and latency), and manages local and remote query history.
 *
 * The component maintains input state, an ordered message transcript, error and searching states, automatically scrolls as messages update, and exposes controls to start a new chat or clear stored history. It updates the cached `query-history` after searches complete or history is cleared.
 *
 * @returns The React element for the SearchPage.
 */
