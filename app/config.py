...
class Settings(BaseSettings):
    ...
    def extensions_set(self) -> Set[str]:
        ...
        """
        Parses the comma-separated `supported_extensions` configuration into a set of extension strings.
        
        Each entry is stripped of surrounding whitespace. If `supported_extensions` contains consecutive commas or a trailing comma, the resulting set will include an empty string element.
         
        Returns:
            Set[str]: A set of the parsed extension strings (trimmed); may contain `""` for empty segments.
        """
